...
public class nnthuong {
	...
	public nnthuong(int mSach, String tensach, String tentacgia, String namxuatban, int soluong, double gia1) {
		MSach = mSach;
		Tensach = tensach;
		Tentacgia = tentacgia;
...
class Quanlisach{	
	...
	public void Nhapthongtin() {
		...
		for (int i=1;i<=n;i++) {
			...
			nnthuong s=new nnthuong(id,name,tacgia,nam,sl,gia);
			list.add(s);
		}
		System.out.println("\n---------------------\n");
	}
